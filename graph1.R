...
#use df1 : load(file='./data/badata.Rdata')
# Data
...
#scatter Plot
plot(adtv, sales) #(x,y)
plot(x=adtv, y=adweb, pch=8, type='p', col='green')  #pch=Plotting symbol
#type can be p for point and l for line plots
#pch refers to plotting symbol
abline(lm(adweb ~ adtv))  #Like least square fit

#Install package car before proceeding
