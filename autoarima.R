...
stl(AirPassengers, s.window = 'periodic') #Seasonal values are periodic and not varying according to the year, stl gives he value of season value, trend and irregular components
